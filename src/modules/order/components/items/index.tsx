              ...
              <div className="grid grid-cols-[122px_1fr] gap-x-4" key={item.id}>
                ...
                <div className="flex flex-col justify-between flex-1">
                  <div className="flex flex-col flex-1 text-small-regular">
                    <div className="flex flex-wrap small items-start justify-between">
                      <div>
                        <h3 className="text-base-regular overflow-ellipsis overflow-hidden whitespace-nowrap mr-4 max-w-[100px]">
                          <Link
