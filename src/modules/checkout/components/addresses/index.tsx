  ...
  return (
    <div className="bg-white">
      <div className="text-xl-semi flex items-center gap-x-4 px-8 pb-6 pt-8">
        <div className="bg-gray-900 w-10 small:w-8 h-8 rounded-full text-white flex justify-center items-center text-sm">
          1
        </div>
      ...
      {isEdit ? (
        <div className="px-8 pb-8">
          ...
          <div className="mt-6">
            <Checkbox
              label="La misma dirección que la de facturación"
              checked={checked}
              onChange={onChange}
            />
          </div>
        ...
        <div>
          <div className="bg-gray-50 px-8 py-6 text-small-regular">
            {cart && cart.shipping_address ? (
              <div className="flex items-start gap-x-6 small:gap-x-8">
                ...
                <div className="flex items-start justify-between w-full">
                  <div className="flex flex-col">
                    ...
                    <div className="mt-4 flex flex-col">
                      ...
                      <span>{cart.email?.slice(0,12)}...</span>
                    </div>
                    {checked && (
                      <div className="flex items-center gap-x-3 small:gap-x-2 mt-6">
                        <div className="flex items-center justify-center border border-gray-700 bg-gray-100 w-4 h-4">
                          ✓
                        </div>
                        <span>Misma dirección que la de facturación</span>
                      </div>
                    )}
                  </div>
                  <div>
          ...
          {!checked && (
            <div>
              <div className="text-xl-semi flex items-center gap-x-4 px-8 pb-6 pt-8">
                <div className="bg-gray-900 w-10 small:w-8 h-8 rounded-full text-white flex justify-center items-center font-mono text-sm">
                  2
                </div>
                <h2>Dirección de facturación</h2>
              </div>
